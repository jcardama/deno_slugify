 ...
 */
export function slugify(string: string, options: any = {}): string {
  options =
    typeof options === "string" ? { replacement: options } : options || {};

  var slug = string
    .split("")
    .reduce(function(result: string, ch: string): string {
      return (
        result +
...
export namespace slugify {
  ...
  export let extend = function(customMap: object): void {
